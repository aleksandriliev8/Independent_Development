...
namespace CityInfo.API.Controllers
{
    ...
    public class FilesController : ControllerBase
    {
        ...
        {
            //look the actual file, depending on the fileId...
            //demo code
        ...
        public async Task<ActionResult> CreateFile(IFormFile file)
        {
            ...
            //Create the file path. Avoiding using file.FileName, as an attacker can provide a
            //malcious one, including full paths or relative paths.
